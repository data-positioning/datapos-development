...
const connectorOperationSchema = z.union([z.literal("abortOperation"), z.literal("authenticateConnection"), z.literal("createObject"), z.literal("describeConnection"), z.literal("dropObject"), z.literal("findObject"), z.literal("getRecord"), z.literal("listNodes"), z.literal("previewObject"), z.literal("removeRecords"), z.literal("retrieveRecords"), z.literal("upsertRecords")]);
...
export const connectorConfigSchema = moduleConfigSchema.extend({
    ...
    vendorAccountURL: z.string().optional(),
    vendorDocumentationURL: z.string().optional(),
    vendorHomeURL: z.string().optional()
});
